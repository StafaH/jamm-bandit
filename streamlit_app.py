...
def display_faces_page(state):
    ...
    st.sidebar.slider('age', -1.00, 1.00, value=0)
    st.sidebar.slider('gender', -1.00, 1.00, value=0)
    st.sidebar.slider('smile', -1.00, 1.00, value=0)
    st.sidebar.slider('pitch', -1.00, 1.00, value=0)
    st.sidebar.slider('roll', -1.00, 1.00, value=0)
    st.sidebar.slider('yaw', -1.00, 1.00, value=0)
    st.sidebar.slider('eye-eyebrow distance', -1.00, 1.00, value=0)
    st.sidebar.slider('eye distance', -1.00, 1.00, value=0)
    st.sidebar.slider('eye ratio', -1.00, 1.00, value=0)
    st.sidebar.slider('eyes open', -1.00, 1.00, value=0)
    st.sidebar.slider('nose ratio', -1.00, 1.00, value=0)
    st.sidebar.slider('nose tip', -1.00, 1.00, value=0)
    st.sidebar.slider('nose-mouth distance', -1.00, 1.00, value=0)
    st.sidebar.slider('mouth ratio', -1.00, 1.00, value=0)
    st.sidebar.slider('mouth open', -1.00, 1.00, value=0)
    st.sidebar.slider('lip ratio', -1.00, 1.00, value=0)
